...
parser.add_argument('-opt', type=str, default='C:/Users/yxx/Desktop/FFTLOL/options/train/train_Enhance_test.yml', help='Path to options YMAL file.')
...
for test_loader in test_loaders:
    ...
    dataset_dir = osp.join(opt['path']['test_root'])
    ...
    if test_control == 1:
        for data in test_loader:
            need_GT = True
            #if test_loader.dataset.opt['dataroot_GT'] is None else True
